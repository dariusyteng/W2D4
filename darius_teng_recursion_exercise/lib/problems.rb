...
#     n = base * pow(base, exponent)
#     exponent -= 1
#   	n
# end
def pow(base, exponent)
    return 1 if exponent == 0
    n = base * pow(base, exponent-1)
end
...
def reverse_string(str)
    ...
    # return str if str.length == 1   Not needed. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
